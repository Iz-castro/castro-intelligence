...
11. **J11 — Tarefas fora do repo (donos e prazos como gate formal):** environment versionado do agente (sair do DRAFT), interaction logging/retention do Dialogflow + Cloud Logging do projeto do agente, TTL da ValMemory (`val-castrochat`, functions da clínica), limpeza de IndexedDB nas máquinas que atenderam varizemed.
