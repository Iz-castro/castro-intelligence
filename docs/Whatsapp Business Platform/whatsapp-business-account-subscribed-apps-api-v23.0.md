...
| Method | Endpoint |
|--------|----------|
| DELETE | [/&#123;Version&#125;/&#123;WABA-ID&#125;/subscribed_apps](#delete-version-waba-id-subscribed-apps) |
| GET | [/&#123;Version&#125;/&#123;WABA-ID&#125;/subscribed_apps](#get-version-waba-id-subscribed-apps) |
| POST | [/&#123;Version&#125;/&#123;WABA-ID&#125;/subscribed_apps](#post-version-waba-id-subscribed-apps) |

&lt;jumplink id=&quot;delete-version-waba-id-subscribed-apps&quot;&gt;&lt;/jumplink&gt;
...
| WABA-ID | string | ✓ | WhatsApp Business Account ID. This ID can be found in your WhatsApp Manager or through business management APIs. |
...
&lt;jumplink id=&quot;get-version-waba-id-subscribed-apps&quot;&gt;&lt;/jumplink&gt;
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| fields | string |  | Comma-separated list of fields to include in the response. If not specified, default fields will be returned. Available fields: id, name, link |
...
**Schema**: [SubscribedAppsResponse](#subscribedappsresponse)
...
&lt;jumplink id=&quot;post-version-waba-id-subscribed-apps&quot;&gt;&lt;/jumplink&gt;
...
**Schema**: [SubscriptionRequest](#subscriptionrequest)
...
|----------|------|----------|-------------|
| id | string | ✓ | Unique identifier for the subscribed application |
| name | string | ✓ | Name of the subscribed application |
| link | string |  | URL link to the application |
...
| override_callback_uri | string |  | Custom webhook callback URL for this subscription |

&lt;jumplink id=&quot;subscribedappsresponse&quot;&gt;&lt;/jumplink&gt;
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| data | array of [SubscribedApp](#subscribedapp) | ✓ | Array of subscribed applications |

&lt;jumplink id=&quot;subscriptionrequest&quot;&gt;&lt;/jumplink&gt;
### SubscriptionRequest
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| override_callback_uri | string |  | Custom webhook callback URL to override app default |
| verify_token | string |  | Verification token for webhook security |

&lt;jumplink id=&quot;subscriptionresponse&quot;&gt;&lt;/jumplink&gt;
...
| data | array of [SubscribedApp](#subscribedapp) |  | Array containing subscription details |
