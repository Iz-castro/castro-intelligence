...
| Method | Endpoint |
|--------|----------|
| POST | [/&#123;Version&#125;/&#123;Phone-Number-ID&#125;/verify_code](#post-version-phone-number-id-verify-code) |

&lt;jumplink id=&quot;post-version-phone-number-id-verify-code&quot;&gt;&lt;/jumplink&gt;
...
| Phone-Number-ID | string | ✓ | The WhatsApp Business Account phone number ID that needs verification. This ID is provided when you add a phone number to your WhatsApp Business Account. |
...
**Example**:\n```json\n&#123;
    &quot;error&quot;: &#123;
        &quot;message&quot;: &quot;Your app doesn&#039;t have permission to verify this phone number&quot;,
        &quot;type&quot;: &quot;OAuthException&quot;,
        &quot;code&quot;: 200,
...
**Example**:\n```json\n&#123;
    &quot;error&quot;: &#123;
        ...
        &quot;code&quot;: 100,
        &quot;fbtrace_id&quot;: &quot;AXsgnV2Cm3ZMGF3dF_cfYIn&quot;,
        &quot;error_user_title&quot;: &quot;Verification Failed&quot;,
        &quot;error_user_msg&quot;: &quot;The verification code you entered is invalid or has expired&quot;
    &#125;
&#125;\n```
...
|----------|------|----------|-------------|
| code | string | ✓ | The verification code received via SMS or voice call |
...
| id | string |  | The phone number ID that was verified |
