...
| Method | Endpoint |
|--------|----------|
| GET | [/&#123;Version&#125;/&#123;Phone-Number-ID&#125;/whatsapp_business_encryption](#get-version-phone-number-id-whatsapp-business-encryption) |
| POST | [/&#123;Version&#125;/&#123;Phone-Number-ID&#125;/whatsapp_business_encryption](#post-version-phone-number-id-whatsapp-business-encryption) |

&lt;jumplink id=&quot;get-version-phone-number-id-whatsapp-business-encryption&quot;&gt;&lt;/jumplink&gt;
...
| Name | Type | Required | Description |
|------|------|----------|-------------|
| fields | string |  | Comma-separated list of fields to include in the response. If not specified, all available fields will be returned. Available fields: business_public_key, business_public_key_signature_status |
...
|----------|------|----------|-------------|
| data | array of [WhatsAppBusinessEncryptionInfo](#whatsappbusinessencryptioninfo) |  |  |
...
**Example**:\n```json\n&#123;
    &quot;error&quot;: &#123;
        &quot;message&quot;: &quot;Your app doesn&#039;t have permission to access this WhatsApp Business phone number&quot;,
        &quot;type&quot;: &quot;OAuthException&quot;,
        &quot;code&quot;: 200,
...
&lt;jumplink id=&quot;post-version-phone-number-id-whatsapp-business-encryption&quot;&gt;&lt;/jumplink&gt;
...
**Schema**: [WhatsAppBusinessEncryptionUploadRequest](#whatsappbusinessencryptionuploadrequest)
...
**Schema**: [WhatsAppBusinessEncryptionUploadResponse](#whatsappbusinessencryptionuploadresponse)
...
&lt;jumplink id=&quot;whatsappbusinessencryptioninfo&quot;&gt;&lt;/jumplink&gt;
### WhatsAppBusinessEncryptionInfo

Business encryption public key information and verification status

| Property | Type | Required | Description |
|----------|------|----------|-------------|
| business_public_key | string | ✓ | The business public key used for encrypting message payloads. This key is used to encrypt data channel requests and responses. |
| business_public_key_signature_status | [BusinessPublicKeyVerificationStatus](#businesspublickeyverificationstatus) | ✓ |  |

&lt;jumplink id=&quot;businesspublickeyverificationstatus&quot;&gt;&lt;/jumplink&gt;
### BusinessPublicKeyVerificationStatus

Status of business public key signature verification

**Type**: string

**Enum Values**: &quot;VALID&quot;, &quot;MISMATCH&quot;

&lt;jumplink id=&quot;whatsappbusinessencryptionuploadrequest&quot;&gt;&lt;/jumplink&gt;
...
| Property | Type | Required | Description |
|----------|------|----------|-------------|
| business_public_key | string | ✓ | The business public key in PEM format to be uploaded and signed. Must be a valid RSA public key that will be used for payload encryption. |

&lt;jumplink id=&quot;whatsappbusinessencryptionuploadresponse&quot;&gt;&lt;/jumplink&gt;
