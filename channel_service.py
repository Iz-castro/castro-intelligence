...
def create_channel(
    ...
    """
    # ID do canal vem do contador GLOBAL, NAO do por-tenant: a colecao
    # `channels` e FLAT/global (_flat_document), entao um contador por-tenant
    # faria tenants diferentes gerarem os mesmos ids (1,2,...) e um SOBRESCREVER
    # os canais do outro (incidente 2026-07-16: varizemed sobrescreveu os canais
    # 1 e 2 do hubloc). Precisa ser tenant_id="" (string vazia): None faria o
    # next_sequence cair no contexto atual (o tenant sendo provisionado) e
    # colidir de novo; "" pula o contexto e forca o ramo do contador flat global.
    channel_id = next_sequence("channels", tenant_id="")
    now = utcnow()
